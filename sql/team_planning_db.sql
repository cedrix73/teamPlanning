...
CREATE TABLE IF NOT EXISTS ressource (
  ...
  numBadge varchar(255) DEFAULT NULL,
  dateRestitutionBadge date DEFAULT NULL,
  dateCharteAdminSOC date DEFAULT NULL,
  dateSensibilitationSOC date DEFAULT NULL,
  resiliationRestitutionMateriel varchar(45) DEFAULT NULL,
  dateEntree date DEFAULT NULL,
  dateSortie date DEFAULT NULL,
  commentaire text,
  numSecurid varchar(45) DEFAULT NULL,
  KEY departement_idx (departement_id),
